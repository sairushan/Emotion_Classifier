...
path="/content/drive/MyDrive/Emotion_Classifier/Emotion_train.npy"
dataset=np.load(path,allow_pickle=True)
print(dataset.shape)

train_inputs=[]
train_targets=[]
for img,target in dataset[:2532]:
...
model.add(Conv2D(64,(3,3),padding="same",input_shape=normalised_train_inputs.shape[1:])) 
...
filepath="/content/drive/MyDrive/Emotion_Classifier/Models/emotion_best.hdf5"
